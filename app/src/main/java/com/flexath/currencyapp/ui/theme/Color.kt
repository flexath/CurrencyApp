...
// Light Theme Colors
val LightPrimary = Color(0xFF8652FF)
val LightSecondary = Color(0xFFECE7FF)
val LightBackground = Color(0xFFF9F9F9)
val LightTitleText = Color(0xFF000000)
val LightBodyText = Color(0xFF293032)
...
val DarkSecondary = Color(0xFF2C1D49)
val DarkBackground = Color(0xFF101110)
val DarkTitleText = Color(0xFFB3B9B3)
val DarkBodyText = Color(0xFF8E938E)
